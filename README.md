...
2. Take **20–30 photos** with your laptop webcam as I said ealier. Best to took pictures from the  folder named checkerboard_images as reference of your images that you'll be taking from you webcam. Use either printed checker board on A4 paper or on Tab. You can find a picture named "pattern.png" either use it via your tab or download any checkerboard pattern.
